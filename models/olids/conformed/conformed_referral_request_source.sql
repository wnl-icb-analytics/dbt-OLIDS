{{
    config(
        materialized='table',
        transient=true,
        alias='referral_request_source')
}}

/*
Original referral-request source content, including misrouted non-referral codes.
Expanded observations retain these records before terminology classifies referrals.
*/
