...
SELECT
    ...
    priority_map.mapped_concept_code AS referral_request_priority_code,
    priority_map.mapped_concept_display AS referral_request_priority_display,
    ...
    type_map.mapped_concept_code AS referral_request_type_code,
    type_map.mapped_concept_display AS referral_request_type_display,
    ...
    specialty_map.mapped_concept_code AS referral_request_specialty_code,
    specialty_map.mapped_concept_display AS referral_request_specialty_display,
    src.mode,
...
LEFT JOIN {{ ref('conformed_concept_map') }} AS priority_map
    ON
        src.referral_request_priority_source_concept_id
        = priority_map.source_concept_id
LEFT JOIN {{ ref('conformed_concept_map') }} AS type_map
    ON src.referral_request_type_source_concept_id = type_map.source_concept_id
LEFT JOIN {{ ref('conformed_concept_map') }} AS specialty_map
    ON
        src.referral_request_specialty_source_concept_id
