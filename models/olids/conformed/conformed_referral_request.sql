    ...
    ROW_NUMBER()
        OVER (
            ...
            ORDER BY
                ...
                priority_map.target_display NULLS LAST,
                priority_map.target_concept_id NULLS LAST,
                type_map.target_display NULLS LAST,
                type_map.target_concept_id NULLS LAST,
                specialty_map.target_display NULLS LAST,
                specialty_map.target_concept_id NULLS LAST
        )
    = 1
