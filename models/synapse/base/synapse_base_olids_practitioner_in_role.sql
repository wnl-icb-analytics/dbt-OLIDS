...
Pattern: Infrastructure table â€” the source-side record_owner_organisation_code
...
FROM {{ source('olids_common', 'PRACTITIONER_IN_ROLE') }} AS src
INNER JOIN {{ ref('synapse_base_olids_organisation') }} AS org
