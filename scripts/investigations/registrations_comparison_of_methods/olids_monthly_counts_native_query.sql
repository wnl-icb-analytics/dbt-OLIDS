...
patient_with_age AS (
    SELECT
        ...
        END AS LIFE_STAGE
    FROM
        "NCL_Data_Store_OLIDS_Alpha".OLIDS_MASKED.PATIENT P
),
...
olids_overall_counts AS (
    ...
    FROM
        ...
        INNER JOIN "NCL_Data_Store_OLIDS_Alpha".OLIDS_COMMON.ORGANISATION O ON PEA.ORGANISATION_ID_PUBLISHER = O.ID
    WHERE
